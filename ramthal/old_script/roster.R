...
# Identifying landmark and neighbour's name ----

ifmr_base_2016 %>% select(1,A13,A16) %>%  
  rename(landmark=A13 ,neighbour_name=A16)%>%
  kable() %>% kable_minimal()	

ifmr_mid_2018 %>% select (1,a9,a12) 
