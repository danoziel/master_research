...
```{r pressure1, echo=FALSE, message = FALSE, warning =FALSE, out.width='97%'}
...
```{r pressure2, echo=FALSE, message = FALSE, warning =FALSE , out.width='97%' }
...
```{r pressure3, echo=FALSE, message = FALSE, warning =FALSE, out.width='97%' }
