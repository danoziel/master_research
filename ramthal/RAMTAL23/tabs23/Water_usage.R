...
a_rmtl_srvy22 %>% count (mm5,m62a) %>% mutate()

## list_groups_rmtl 1702 obj
## rmtl_groups    1612 obj
...
a_rmtl_srvy22 <- Ramthal_Karnataka_Cleaned_Data
...
# Is your land coming under such a government project?
...
L7 <- 
  a_rmtl_srvy22 %>%select(id,starts_with("l7_"))%>%  
  mutate(
